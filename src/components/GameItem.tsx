...
export default function GameItem(props: gamePreviewCard): ReactElement {
  return (
    <div className="border rounded-[5%] flex flex-col bg-zinc-100 transform hover:scale-105 duration-100 w-[18%]">
      <img
        src={props.backgroundImage}
        alt={props.title}
        className="block rounded-t-[5%]"
      />
      <div>
